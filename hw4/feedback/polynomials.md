...
- Induction should be over both variables in both cases: -2
- You should look to use the given identity in you proof: -2
- Inductive hypothesis is not used: -1
...
true
```
**TA COMMENT (leid0065)**: -2 some inductive cases are missing and/or incorrect.
-1 I.H. for Add and Mul should be different. Score: 7/10.
